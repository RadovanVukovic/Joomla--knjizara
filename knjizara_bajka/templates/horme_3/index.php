...
<head>
  ...
  <body id="body" class="<?php echo $pageclass . ' ' . $bodyclass; ?>" <?php if ($background) {echo $bg;} // Background image ?>>
    ...
    <div class="bklink" style="text-align: center;font-size: 13px;padding: 5px 0;background-color:#333;color:#fff;border-top: 1px solid#555;"><a href="https://www.olympianthemes.com/virtuemart-templates.html">VirtueMart template</a> by olympianthemes.com</div>
  </body>
</html>